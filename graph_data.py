...
graph = {
    ...
    'graph-2':{
        ...
        'graph-3':{
        'Sophia': {'N2': 0.7, 'Peter': 0.6},
        'Emma': {'Sophia': 0.7, 'Leo': 0.3, 'Amy': 0.9},
        'Leo': {'Emma': 0.3, 'Peter': 0.6, 'Mia': 0.3},
        'Peter': {'Sophia': 0.6, 'Leo': 0.6, 'Amy': 0.5, 'Mia': 0.6},
        'Amy': {'Leo': 0.3, 'Peter': 0.6, 'Sarah': 0.2},
        'Mia': {'Emma': 0.9, 'Peter': 0.5},
        'Sarah': {'Mia': 0.2}
        }
}
